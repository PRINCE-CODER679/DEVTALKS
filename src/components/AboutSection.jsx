      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 space-y-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#222222] pb-8">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#141414] border border-[#FF5500]/40 text-[#FFAA00] font-mono text-xs font-bold tracking-widest uppercase shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-[#111111] border border-[#262626] rounded-2xl space-y-4 hover:border-[#FF5500]/50 hover:bg-[#161616] transition-all shadow-md">
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 text-neutral-400 transition-transform ${openFaq === idx ? 'rotate-180 text-[#FF5500]' : ''}`} />
                </button>
