 ...
 * 
 * First implementation of the Digital Reconstructed Speaker Portrait.
 * Features:
 * - Circular portrait interacting with boundary
 * - Irregular fragmented/glitch slice portions extending outside circular edge
 * - Multi-layer digital displacement & offset ghosting slices
 * - Connected 3D orbital ring system with thin arcs, broken circular segments & rotating markers
 * - Orange laser scanline reconstruction sweep on active transition
 * - Digital pixel matrix overlay keeping center face recognizable
 * - Floating orange digital embers & micro-particles
 * - Responsive sizing and smooth state transitions
 */
export default function SpeakerReconstructedPortrait({
  ...
  // Image source resolution: use the silhouette image for mystery reconstructed state, and revealed photo upon reveal
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center select-none overflow-visible pointer-events-none">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-visible z-20">
        ...
        <svg 
          viewBox="0 0 380 380" 
          className="w-[290px] xs:w-[320px] sm:w-[380px] h-[290px] xs:w-[320px] sm:h-[380px] overflow-visible pointer-events-none"
        >
          <defs>
      ...
      <div className="relative z-10 flex items-center justify-center my-auto pointer-events-none">
        ...
        >
          ...
          {/* ========================================================================= */}
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-[#ff5a1f]/80 shadow-[inset_0_0_20px_rgba(0,0,0,0.8),_0_0_25px_rgba(255,90,31,0.3)] bg-[#0a0a0a] flex items-end justify-center pointer-events-none">
            ...
            {/* Digital Pixel Matrix Perimeter Pattern */}
            {!isRevealed && (
              <div 
